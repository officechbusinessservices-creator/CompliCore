    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          <Link href="/pms-sync" className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30 hover:bg-blue-500/20 transition-colors flex flex-col items-center text-center gap-2">
          ...
          <Link href="/pms-import" className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/30 hover:bg-emerald-500/20 transition-colors flex flex-col items-center text-center gap-2">
          ...
          <Link href="/pms-status" className="p-4 rounded-lg bg-violet-500/10 border border-violet-500/30 hover:bg-violet-500/20 transition-colors flex flex-col items-center text-center gap-2">
          ...
          <Link href="/pms-troubleshoot" className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30 hover:bg-amber-500/20 transition-colors flex flex-col items-center text-center gap-2">
          ...
          <Link href="/rate-parity" className="p-4 rounded-lg bg-pink-500/10 border border-pink-500/30 hover:bg-pink-500/20 transition-colors flex flex-col items-center text-center gap-2">
