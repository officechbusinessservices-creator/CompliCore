        ...
        {!isFullscreen && (
          <div className="w-64 bg-zinc-900 border-l border-zinc-800 p-4 overflow-y-auto">
            ...
            <div className="mt-6 p-4 bg-zinc-800 rounded-xl">
              ...
              <Link href="/prototype/property/prop-1" className="block w-full py-2 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-center text-sm font-medium transition-colors">
                View Listing
              </Link>
            </div>
          </div>
